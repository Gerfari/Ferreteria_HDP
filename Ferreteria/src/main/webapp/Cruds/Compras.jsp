<%-- 
    Document   : Compras
    Created on : 2 may 2024, 22:29:41
    Author     : herna
--%>
...
<html>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-xl-6" style="text-align: right">
                                    <div class="mini-stat clearfix bg-white">
                                        <span class="mini-stat-icon bg-blue-grey mr-0 float-right"><i class="mdi mdi-black-mesa"></i></span>
                                        <div class="mini-stat-info">
                                            <button class="btn btn-primary btn_comprar" id="realizar_compra" value="si_comprar">REALIZAR COMPRA</button>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                                </div>
    ...
    <script src="../js/ComprarProductos.js"></script>
