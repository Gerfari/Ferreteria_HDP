...
import com.ues.models.dao.ListaProvProdDAO;
 ...
 * @author kevin
 */
@WebServlet(name = "ControllerListProvProd", urlPatterns = {"/ControllerListProvProd"})
public class ControllerListProvProd extends HttpServlet {
        ...
        switch (filtro) {
            case "si_consulta":
                ...
                String el_estado = request.getParameter("estado");
                 {
                    try {
                        ListaProvProdDAO dao = new ListaProvProdDAO();
                        ListProvProd = dao.selectAllProveedorProducto();
                        html += "<table id=\"tabla_provprod\""
                                ...
                                + "</tbody>";
                        int cont = 0;
                        for (ListaProveedorProductoDTO dto : ListProvProd) {
                            cont++;
                            html += "<tr>";
                            html += "<td>" + cont + "</td>";
