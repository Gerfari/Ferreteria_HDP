...
<html>
    <head>
        ...
        <title>PROVEEDORES CON MEJOR DEMANDA</title>
    ...
    <body class="fixed-left">
        ...
        <div id="wrapper">
                            ...
                            <div class="row">
                                <div class="mini-stat clearfix bg-white">
                                    ...
                                    <div class="mini-stat-info">                                            
                                        <H2 style="text-align: center;">PROVEEDORES CON MEJOR DEMANDA</H2>
                                        <span id="Cantidad_prov" class="counter text-blue-grey">0</span>
                                        Registros
                                    </div>
            ...
            <!-- ESTA PARTE SE DESPLIEGA CUANDO LE DOY CLICK A REGISTRAR AUTOR -->
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form name="formulario_registro" id="formulario_registro">
                                ...
                                <!-- ESTA PARTE ASIGNA EL VALOR AL FILTRO DEL CASE -->
                                <!-- case "si_registro":-->
    ...
    <script src="../js/prov_demandado.js"></script>
