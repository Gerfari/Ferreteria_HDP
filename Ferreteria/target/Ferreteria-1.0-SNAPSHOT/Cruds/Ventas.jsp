<%-- 
    Document   : Ventas
    Created on : 8 jun. 2024, 14:48:16
    Author     : JAVIER MONGE
--%>
...
<html>
                    ...
                    <div class="page-content-wrapper">
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-md-12 col-xl-12" id="registrar_compra" style="text-align: center">
                                    <div class="mini-stat clearfix bg-white">
                                        <span class="mini-stat-icon bg-teal mr-0 float-right"><i class="mdi mdi-account"></i></span>
                                        <div class="mini-stat-info">
                                            <H3 id="title">REALIZAR VENTA</H3>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-xl-6">
                                    <div class="mini-stat clearfix bg-white">
                                        ...
                                        <div class="mini-stat-info">
                                            <span id="Productos_Disponibles" class="counter text-blue-grey">0</span>
                                            PRODUCTOS DISPONIBLES
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-xl-6" style="text-align: right">
                                    <div class="mini-stat clearfix bg-white">
                                        <span class="mini-stat-icon bg-blue-grey mr-0 float-right"><i class="mdi mdi-black-mesa"></i></span>
                                        <div class="mini-stat-info">
                                            <button class="btn btn-primary btnvender" id="realizar_venta" value="si_vender">REALIZAR VENTA</button>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                                </div>
                                ...
                                <div class="col-6">
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                            ...
                                            <div id="tabla_seleccionados">
                                                <div class="table-responsive">
                                                    <table id="tabla_selec" class='table table-bordered nowrap' cellspacing='1px' width='100%'>
                                                        <thead>
                                                            <tr>
                                                                <th>PRODUCTO</th>
                                                                <th>CANTIDAD</th>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form name="formulario_registro" id="formulario_registro">
                                <input type="hidden" id="llave_venta" name="llave_venta" value="">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" autocomplete="off" name="fechaventa"
                                                   data-parsley-error-message="Campo requerido" id="fechaventa"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Cliente:</label>
                                            <select id="clienteSeleccionado" name="clienteSeleccionado" class="form-control" required>
    ...
    <script src="../js/VenderProductos.js"></script>
